...
text(600,180,'Press Space to Continue', 'fontsize',72, 'fontname','Arial', 'HorizontalAlign','center', 'VerticalAlign','middle', 'color',[240 240 240]/255);
hFrame = getframe(gcf);
