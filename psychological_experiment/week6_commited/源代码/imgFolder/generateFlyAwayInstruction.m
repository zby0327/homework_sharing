...
text(600,180,'Angry Bird Fly Away', 'fontsize',72, 'fontname','Arial', 'HorizontalAlign','center', 'VerticalAlign','middle', 'color',[240 240 240]/255);
hFrame = getframe(gcf);
...
alphaMatrix(alphaMatrix_BW) = 0; alphaMatrix(~alphaMatrix_BW) = 0.7;
pngFileName = 'ABird_FlyAway_Instruction.png';
